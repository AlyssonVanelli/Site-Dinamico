...
app.post('/admin', (req,res) =>{
    usuarios.map(function(val){
        if(val.user == req.body.email && val.password == req.body.password){
...
app.get('/admin/destaque/:id',upload.single("image_destaque"), (req,res)=>{
    Destaques.findOneAndUpdate({_id: req.params.id},{new:true},function(err,resposta){
...
app.get('/admin/posts/:id',upload.single("image_post"), (req,res)=>{
    Posts.findOneAndUpdate({_id: req.params.id},{new:true},function(err,resposta){
...
app.get('/admin/noticia/:id',upload.single("image_noticia"), (req,res)=>{
    Noticias.findOneAndUpdate({_id: req.params.id},{new:true},function(err,resposta){
...
app.get('/admin/estudo/:id',upload.single("image_estudo"), (req,res)=>{
    Estudos.findOneAndUpdate({_id: req.params.id},{new:true},function(err,resposta){
